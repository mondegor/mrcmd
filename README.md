...
- `curl -fsSL -o mrcmd.zip https://github.com/mondegor/mrcmd/archive/refs/tags/v0.6.2.zip --ssl-no-revoke`
- `unzip mrcmd.zip && rm mrcmd.zip && mv mrcmd-0.6.2 mrcmd && chmod +x ./mrcmd/cmd.sh`
