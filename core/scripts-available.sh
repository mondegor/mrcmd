...
# private
mrcmd_scripts_available_list() {
  mrcmd_check_var_required MRCMD_SCRIPTS_LOADED_ARRAY
  mrcmd_check_var_required MRCMD_SCRIPTS_LOADED_DIRS_ARRAY
  ...
  do
    ...
    SCRIPT_DIR=${MRCMD_DIR_ARRAY[${DIR_INDEX}]}
    SCRIPT_SRC=${MRCMD_SCRIPTS_SRC_ARRAY[${DIR_INDEX}]}
    ...
    mrcmd_scripts_available_echo_function "${SCRIPT_NAME}" "${SCRIPT_DIR}/${SCRIPT_SRC}/${SCRIPT_NAME}.sh"
